...
const statusConfig = {
  idle: { label: "Siap", bg: "rgba(0,113,77,0.1)", text: "var(--color-success)" },
  working: { label: "Beroperasi", bg: "rgba(37,99,235,0.1)", text: "var(--color-brand-accent)" },
  charging: { label: "Mengisi", bg: "rgba(180,83,9,0.1)", text: "#B45309" },
};
  ...
  return (
    <>
          ...
          >
            ...
            <div className="p-3">
              ...
              <p className="text-xs mt-0.5" style={{ color: "var(--color-muted-text)" }}>
                {vehicle.vehicleType || vehicle.model} - {vehicle.vin}
              </p>
            </div>
          </div>
        </Link>
      ...
      <ConfirmDeleteModal
        ...
        message="Data kendaraan akan dihapus permanen dan tidak dapat dikembalikan."
        onConfirm={() => {
