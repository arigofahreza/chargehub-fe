...
export const mockTemplates: NotificationTemplate[] = [
  {
    ...
    status: "active", employeeCount: 8, phoneCount: 8, lastSent: "2026-08-05T08:30:00Z",
  },
  {
    ...
    status: "active", employeeCount: 3, phoneCount: 3, lastSent: "2026-08-04T10:00:00Z",
  },
  {
    id: "3", name: "Route Assignment",
    message: "Hi {{name}}, you have been assigned route {{route_id}} starting at {{time}}. Vehicle: {{fleet_id}}.",
    status: "active", employeeCount: 10, phoneCount: 10, lastSent: "2026-08-06T06:00:00Z",
  },
  {
    ...
    status: "inactive", employeeCount: 0, phoneCount: 0, lastSent: "2026-07-28T07:00:00Z",
  },
];
